...
import { AccelerometerData, MagnetometerData } from 'expo-sensors';
...
export function calculateOrientation(
  ...
  // Calculer le yaw (heading) - FORMULE OBLIGATOIRE
  // Android : X = Est, Y = Nord
  // atan2(by, bx) donne 0° = Nord (by = composante Nord, bx = composante Est)
