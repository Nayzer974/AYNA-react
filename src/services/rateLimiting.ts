 ...
 * - 15 messages toutes les 5 heures
 */

import AsyncStorage from '@react-native-async-storage/async-storage';

const RATE_LIMIT_KEY = 'ayna_chat_rate_limit';
const MESSAGE_LIMIT = 15; // 15 messages
const TIME_WINDOW_MS = 5 * 60 * 60 * 1000; // 5 heures en millisecondes
...
export async function checkRateLimit(): Promise<{
  ...
  try {
    ...
    // Si la fenêtre de 5 heures est expirée, réinitialiser
